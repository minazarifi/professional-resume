...
\textcolor{darkcol} {\cvtext{\textbf{#1}} }
}
...
%--------EDUCATION------------------------------------
            ...
            \cvmetaevent
            {Bachelor of Science :}
            {from Qazvin Azad University in\\ Software Engineering from\\
...
%----------------------Contact------------------------------------
            ...
            \textbf{\textcolor{black} {Email}}: \href{mailto:m101.zarifi@gmail.com}{\color{linkclr}{m101.zarifi@gmail.com}}\\
            \textbf{\textcolor{black} {Mobile} }: +98912 666 22 62\\
            \textbf{\textcolor{black} {LinkedIn}}: \href{http://ir.linkedin.com/pub/Mina}{\color{linkclr}{Mina Zarifi}}  \\
            \textbf{\textcolor{black} {Address}}: Number 36-Sabooniha Street-SHAHR RAY-Tehran-IRAN
            }
