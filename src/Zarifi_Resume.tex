...
\geometry{top=1cm, bottom=1cm, left=0.3cm , right=0.3cm}
\pagestyle{empty}
...
%-----------------------META IMAGE-----------------------------------
 \newcolumntype{c}{>{\centering\arraybackslash} m{0.29\paperwidth}}
            \begin{tabular}{c}
                \begin{tikzpicture}
                    \clip (0,0) circle (3cm);
                    \node[circle ,draw=rulerclr,thin]{\includegraphics[width=1\columnwidth]{zarifi.jpg}};
                    \vspace{3cm}
                \end{tikzpicture}
                \null
            \end{tabular}
...
%----------------------Contact------------------------------------
            ...
            \textbf{\textcolor{black} {Skype ID} }: MINA ZARIFI\\[3pt]
            \textbf{\textcolor{black} {LinkedIn}}: \href{linkedin.com/in/mina-zarifi-7b6a701b5}{\color{linkclr}{mina-zarifi ’s profile}}  \\[3pt]
...
%-------------------WORK EXPERIENCE-----------------------
            ...
            {}
            {\cvlist{
            \item I worked as a member of the Lending team.
            \item I designed and implemented Model Components and Modules of Data Center \\and Edit them.
            \item I Created Report to Users with Crystal Report.
            \item I designed DB with oracle and wrote PL-SQL code.
            }}
            \vfill
            \cvevent
            {Apr 2017 - Present}
            ...
            {}
            {\cvlist{
            \item Backup DB of Tehran municipality ICT Center and keep them up in Home Office.
            }}
            \null
%---------------------certification-------------------------------
...
%\node[circle ,draw=rulerclr,thin]{\includegraphics[width=0.17\columnwidth]{zarifi.jpg}};
                \clip (0,0) circle (3cm);
                \node[circle ,draw=rulerclr,thin]{\includegraphics[width=0.29\columnwidth]{zarifi.jpg}};
            \end{tikzpicture} &
